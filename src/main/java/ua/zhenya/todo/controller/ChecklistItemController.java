...
import ua.zhenya.todo.mappers.checklist.ChecklistReadMapper;
...
public class ChecklistItemController {
    ...
    private final ChecklistReadMapper checklistReadMapper;
    ...
    public ResponseEntity<ChecklistItemResponse> create(Principal principal, @PathVariable Integer taskId, ChecklistItemCreateRequest checkListItemCreateRequest) {
        ...
        ChecklistItemResponse checklistItemResponse = checklistReadMapper.map(checklistItem);
